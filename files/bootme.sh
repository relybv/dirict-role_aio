...
#
# Usage:
# Ubuntu / Debian: wget https://raw.githubusercontent.com/pgomersbach/role_aio/master/files/bootme.sh; bash bootme.sh
#
# Red Hat / CentOS: curl https://raw.githubusercontent.com/pgomersbach/role_aio/master/skeleton/files/bootme.sh -o bootme.sh; bash bootme.sh
...
if [ -d /root/role_aio ]; then
  ...
  echo "Cloning repo"
  git clone https://github.com/relybv/dirict-role_aio.git /root/role_aio
  cd /root/role_aio
fi
