...
# This script installs puppet 3.x and deploy the manifest using puppet apply -e "include role_aio"
# Usage:
# <powershell>
# Set-ExecutionPolicy Unrestricted -Force
# icm $executioncontext.InvokeCommand.NewScriptBlock((New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/relybv/role_aio/master/files/bootme.ps1')) -ArgumentList ("role_aio")
#</powershell>


  param(
    [string]$role = "role_aio",
  )

  $puppet_source = "https://github.com/relybv/dirict-role_aio.git"
